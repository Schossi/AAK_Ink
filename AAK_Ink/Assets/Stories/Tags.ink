...
The character:n tag is meant to set which character is currently active in the narrative
...
The trigger:xxxx tag sets a trigger on the animator of the current character or the executing one if there is none#character:0 #trigger:Surprise